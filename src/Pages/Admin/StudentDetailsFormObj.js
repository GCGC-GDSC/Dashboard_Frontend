...
export const parsedStudentDetailsRef = {
  ...
  total_higher_study_and_pay_crt:
    "Number of students that are choosing higher studies",
  total_not_intrested_in_placments:
    "Number of students intrested in placements",
  total_backlogs: "Backlogs count",
  total_offers: "Total No. of Offers",
  total_multiple_offers: "No. of multiple offers",
  highest_salary: "Highest (Per annum) Rs.in lakhs",
  average_salary: "Average (Per annum)Rs.in lakhs",
  lowest_salary: "Lowest (Per annum) Rs.in lakhs",
  vskp: "Visakhapatnam",
  blr: "Bengaluru",
  hyd: "Hyderabad",
};
